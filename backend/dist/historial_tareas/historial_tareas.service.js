...
exports.HistorialTareasService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("src/prisma/prisma.service");
let HistorialTareasService = class HistorialTareasService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create(body) {
...
exports.HistorialTareasService = HistorialTareasService;
exports.HistorialTareasService = HistorialTareasService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], HistorialTareasService);
//# sourceMappingURL=historial_tareas.service.js.map