...
@Module({
  imports: [UsuariosModule, TareasModule, EstadoTareasModule, HistorialTareasModule, NotificacionesModule, PreferenciasModule, PrioridadTareasModule, TipoTareasModule, PrismaModule],
